      ...
      <section className="container mx-auto px-4 py-16">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
          ...
          <div className="lg:w-1/2 relative">
            <Image
              src={heroImage}
              alt="AI Visualization - Bloai Blog"
              width={600}
              height={400}
      ...
      <section className="container mx-auto px-4 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {trendingPosts.map(post => (
            <Link key={post.id} href="/blog" className="bg-white rounded-xl overflow-hidden hover:shadow-md transition-shadow block">
              <div className="p-6">
                ...
                <span className="mt-4 text-blue-600 hover:text-blue-700 flex items-center gap-2 font-medium">
