      ...
      <section className="bg-white pt-32 pb-20 border-b-2 border-black">
        <div className="container mx-auto px-6 max-w-7xl">
          <div className="text-center mb-16">
            <h1 className="text-3xl md:text-4xl font-extrabold uppercase tracking-widest text-black inline-block border-b-[3px] border-black pb-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {features.map((feature, index) => (
              <div key={index} className="bg-white p-8 rounded-none border-[1.5px] border-black group hover:bg-black transition-colors duration-300">
                ...
                <h2 className="text-lg font-bold uppercase tracking-widest mb-4 text-black group-hover:text-white">{feature.title}</h2>
