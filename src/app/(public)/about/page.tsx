     ...
     <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "description": "Giới thiệu về Bloai Blog",
            "publisher": {
              "@type": "Organization",
              "name": "Bloai Blog",
              "logo": {
        ...
        >
          <div className="container mx-auto px-4 max-w-6xl">
            ...
            >
              ...
              >
                Giới thiệu 
                <span className="bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent"> Bloai</span>
              </motion.h1>
              <motion.p 
                variants={fadeInUp}
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-6">
                <p className="text-lg text-gray-600 leading-relaxed md:text-xl md:leading-relaxed">
                  Bloai được thành lập với mục tiêu trở thành cầu nối giữa lý thuyết AI và thực tiễn ứng dụng. 
